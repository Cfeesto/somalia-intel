...
val SOMALIA_SOURCES = listOf(
    // ── Primary TV/Radio outlets ──────────────────────────────────────────────
    NewsSource("Dalsan TV",       null,                 "https://dalsan.net/feed/",                                               0xFF1565C0, "general"),
    NewsSource("Dawan TV",        null,                 "https://news.google.com/rss/search?q=dawan+tv+somalia&hl=en&gl=SO",      0xFF6A1B9A, "general"),
    ...
    NewsSource("UN OCHA Somalia", null,                 "https://reliefweb.int/country/som/rss.xml",                              0xFF0288D1, "humanitarian"),
    NewsSource("Hiraan Online",   null,                 "https://www.hiiraan.com/rss/news.xml",                                   0xFF37474F, "general"),

    // ── Journalist Google News feeds ──────────────────────────────────────────
    ...
    NewsSource("M.Y. Bakayle",    "Mohamed Y. Bakayle", "https://news.google.com/rss/search?q=%22bakayle%22+somalia&hl=en",       0xFF6D4C41, "politics"),
    ...
    NewsSource("Idiris Alteeso",  "Idiris Alteeso",     "https://news.google.com/rss/search?q=%22idiris+alteeso%22+somalia&hl=en",0xFF546E7A, "general"),
    ...
    NewsSource("Al-Shabaab Watch",null,                 "https://news.google.com/rss/search?q=al-shabaab+somalia+attack&hl=en",   0xFFB71C1C, "security"),
    NewsSource("AMISOM/AUSSOM",   null,                 "https://news.google.com/rss/search?q=amisom+aussom+somalia&hl=en",       0xFF4527A0, "security"),
)
